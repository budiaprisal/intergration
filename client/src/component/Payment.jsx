      ...
      <Container>
        <Row>
          <Col className="mt-5 pt-5" style={{ textAlign: "center" }}>
            <h1
              className="mt-5 mb-4 text-white fw-bold"
            ...
            <p
              ...
              style={{ lineHeight: "2", maxWidth: "500px", margin: "0 auto" }}
            >
        ...
        <Row
          className=" bg-black text-center   mb-4 "
          style={{ marginTop: "50px", marginLeft: "140px" }}
        >
          <Col md={3} sm={6} xs={12}>
            <Card
              className="py-2 bg-black border"
              style={{ borderRadius: "10px" }}
            >
              <Card.Body className="text-light m-auto ">
                <p className="text-center">Netflix Mobile</p>
                <Card.Title
                  className="text-warning"
                  style={{ fontSize: "36px", fontWeight: "bold" }}
                >
                  Rp.30.000.{" "}
                  <BsFillCollectionPlayFill className="text-danger" />
                </Card.Title>
                ...
                <Card.Text
                  type="submit"
                  onClick={() =>
                    handleSubmit.mutate({ price: 30000, days: 30 })
                  }
                  className="text-white text-center py-2 bg-danger"
          ...
          <Col md={3} sm={6} xs={12}>
            ...
            >
              <Card.Body className="text-light m-auto ">
                <p className="text-center">Netflix Basic</p>
                <Card.Title
                  className="text-warning"
                  style={{ fontSize: "36px", fontWeight: "bold" }}
                >
                ...
                <Card.Text
                  type="submit"
                  onClick={() =>
                    handleSubmit.mutate({ price: 80000, days: 30 })
                  }
                  className="text-white text-center py-2 bg-danger"
                  style={{ borderRadius: "20px", cursor: "pointer" }}
                >
          ...
          <Col md={3} sm={6} xs={12}>
            ...
            >
              <Card.Body className="text-light m-auto ">
                <p className="text-center">Netflix Standard</p>
                ...
                <Card.Text
                  type="submit"
                  onClick={() =>
                    handleSubmit.mutate({ price: 150000, days: 30 })
                  }
                  className="text-white text-center py-2 bg-danger"
                  style={{ borderRadius: "20px", cursor: "pointer" }}
                >
